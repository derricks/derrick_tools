...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.derrick_tools.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".derrick_tools" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".derrick_tools")
	}
