...
var spellingBeeSets = [][]string{
	...
	{"NOTICE", "CONCEIT", "INNOCENT", "CONTINENT", "TECTONIC", "CONNECTION", "CONTENTION", "INCONTINENT", "INCONTINENCE"},
	...
	{"TRAP", "APPARAT", "RAPT", "APART", "PART", "TARP", "RATTRAP", "PRAT"},
	...
	{"CLEAT", "CATTLE", "ECLAT", "ACETAL", "LACTATE"},
	{"LADLING", "LADING", "DIALING", "ADDLING"},
	{"MONEY", "YEOMEN"},
	{"GNOME", "GENOME"},
	{"GONE", "EGGNOG"},
	{"THEY", "EYETEETH", "TEEHEE", "TEHEE"},
	...
	{"NODE", "ODEON", "DONE", "DONNED", "NODDED", "DONEE"},
	{"BEFELL", "FEEBLE"},
	...
	{"DEAD", "ADDED"},
	{"DATE", "TATTED", "DATED"},
	{"ACCEDED", "ACCEDED", "ACED", "DECADE", "ACCEDE"},
	{"FUROR", "FOUR", "FROUFROU"},
	{"FROG", "FORGO"},
	{"EXACT", "EXACTA"},
	{"ADDITION", "DONATION"},
	...
	{"BANDEAU", "UNBANNED"},
	{"PINE", "NINEPIN"},
	{"ROCK", "CORK", "CROCK", "CROOK"},
	{"CRAM", "MARACA"},
	{"BAFFLE", "AFFABLE", "FABLE"},
	{"FAIL", "FLAIL", "FILIAL"},
	{"DAMN", "ADMAN", "MADMAN"},
	{"MANY", "MYNA"},
	...
	{"EIGHTEEN", "EIGHTEENTH", "TIGHTEN", "TIGHTENING", "HEIGHTEN", "HEIGHTENING", "NIGHTIE", "TEETHING"},
	{"VENAL", "LEAVEN", "NAVEL"},
	{"MINDED", "MINED", "DENIM"},
	{"RACY", "CARRY"},
	{"ONCE", "CONE", "NONCE"},
	...
	{"BATON", "NANOBOT"},
	{"INKING", "KING", "KINKING", "KINGING"},
	{"ROBIN", "INBORN", "RIBBON"},
	{"ARBORIO", "BARRIO"},
	{"BABOON", "NABOB"},
	{"CORAL", "COLLAR", "CORRAL"},
	{"GRINNING", "RING", "NIGIRI", "RIGGING", "RINGING", "GRIN"},
	{"IGNORING", "GROIN", "GORING", "ORIGIN", "IRONING"},
	{"ROBING", "BORING", "RIBBONING", "ROBBING"},
	{"BORN", "BORON"},
	{"ADDLED", "LADLE", "LADE", "DEAL", "LEAD", "ADDLE", "LADLED", "LADED"},
	{"GLUGGING", "LINGUINI", "LUGING", "GULLING", "LUGGING", "GLUING", "LULLING"},
	{"INKLING", "LIKING", "KILLING", "LINKING", "KILNING"},
	{"UNINTENDED", "UNEDITED", "INTUITED", "UNTIED", "UNITED"},
	{"UNTENDED", "UNTUNED", "TUNED"},
	{"COHORT", "TORCH"},
	{"TEAKETTLE", "LATKE"},
	{"HILT", "TILTH"},
	{"WONT", "WONTON", "TOWN"},
	{"AFFIANT", "FAINT", "ANTIFA"},
	{"GLOOM", "GLOM"},
	{"GLAM", "AMALGAM"},
	{"GAMMA", "MAGMA"},
	{"GOLLY", "GOOGLY", "LOGY"},
	{"INTIMATION", "ANIMATION", "NOMINATION", "IMITATION"},
