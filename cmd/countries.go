...
var countries = []countryInfo{
	...
	countryInfo{10, "Algeria", "Algiers", "Africa"},
	countryInfo{11, "Democratic Republic of Congo", "Kinshasa", "Africa"},
	countryInfo{12, "Saudi Arabia", "Riyadh", ""},
	countryInfo{13, "Mexico", "Mexico City", ""},
	countryInfo{14, "Indonesia", "Jakarta", ""},
	countryInfo{15, "Sudan", "Khartoum", "Africa"},
	countryInfo{16, "Libya", "Tripoli", "Africa"},
	countryInfo{17, "Iran", "Tehran", ""},
	countryInfo{18, "Mongolia", "Ulaanbataar", ""},
	countryInfo{19, "Peru", "Lima", ""},
	countryInfo{20, "Chad", "N'Djamena", "Africa"},
	countryInfo{21, "Niger", "Niamey", "Africa"},
	countryInfo{22, "Angola", "Luanda", "Africa"},
	countryInfo{23, "Mali", "Bamako", "Africa"},
	countryInfo{24, "South Africa", "Pretoria", "Africa"},
	countryInfo{25, "Colombia", "Bogota", ""},
	countryInfo{26, "Ethiopia", "Addis Ababa", "Africa"},
	countryInfo{27, "Bolivia", "Sucre", ""},
	countryInfo{28, "Mauritania", "Nouakchott", "Africa"},
	countryInfo{29, "Egypt", "Cairo", "Africa"},
	countryInfo{30, "Tanzania", "Dodoma", "Africa"},
	countryInfo{31, "Nigeria", "Abuja", "Africa"},
	countryInfo{32, "Venezuela", "Caracas", ""},
	countryInfo{33, "Pakistan", "Islamabad", ""},
	countryInfo{34, "Namibia", "Windhoek", "Africa"},
	countryInfo{35, "Mozambique", "Maputo", "Africa"},
	countryInfo{36, "Turkey", "Ankara", ""},
	countryInfo{37, "Chile", "Santiago", ""},
	countryInfo{38, "Zambia", "Lusaka", "Africa"},
	countryInfo{39, "Myanmar", "Naypyidaw", ""},
	countryInfo{40, "Afghanistan", "Kabul", ""},
	countryInfo{41, "South Sudan", "Juba", "Africa"},
	countryInfo{42, "France", "Paris", ""},
	countryInfo{43, "Somalia", "Mogadishu", "Africa"},
	countryInfo{44, "Central African Republic", "Bangui", "Africa"},
	countryInfo{45, "Ukraine", "Kyiv", ""},
	countryInfo{46, "Madagascar", "Antananarivo", "Africa"},
	countryInfo{47, "Botswana", "Gaborone", "Africa"},
	countryInfo{48, "Kenya", "Nairobi", "Africa"},
	...
	countryInfo{74, "Burkina Faso", "Ouagadougou", "Africa"},
	countryInfo{75, "New Zealand", "Wellington", ""},
	countryInfo{76, "Gabon", "Libreville", "Africa"},
	countryInfo{77, "Guinea", "Conakry", "Africa"},
	countryInfo{78, "United Kingdom", "London", ""},
	countryInfo{79, "Uganda", "Kampala", "Africa"},
	countryInfo{80, "Ghana", "Accra", "Africa"},
	...
	countryInfo{86, "Senegal", "Dakar", "Africa"},
	...
	countryInfo{91, "Tunisia", "Tunis", "Africa"},
	...
	countryInfo{98, "Malawi", "Lilongwe", "Africa"},
	countryInfo{99, "Eritrea", "Asmara", "Africa"},
	countryInfo{100, "Benin", "Porto-Novo", "Africa"},
	countryInfo{101, "Honduras", "Tegucigalpa", ""},
	countryInfo{102, "Liberia", "Monrovia", "Africa"},
	...
	countryInfo{117, "Sierra Leone", "Freetown", "Africa"},
	...
	countryInfo{123, "Togo", "Lome", "Africa"},
	...
	countryInfo{134, "Guinea-Bissau", "Bissau", "Africa"},
	countryInfo{135, "Moldova", "Kishinev", ""},
	countryInfo{136, "Belgium", "Brussels", ""},
	countryInfo{137, "Lesotho", "Maseru", "Africa"},
	countryInfo{138, "Armenia", "Yerevan", ""},
	countryInfo{139, "Solomon Islands", "Honiara", ""},
	countryInfo{140, "Albania", "Tirana", ""},
	countryInfo{141, "Equatorial Guinea", "Malabo", "Africa"},
	countryInfo{142, "Burundi", "Gitega", "Africa"},
	countryInfo{143, "Haiti", "Port-au-Prince", ""},
	countryInfo{144, "Rwanda", "Kigali", "Africa"},
	countryInfo{145, "North Macedonia", "Skopje", ""},
	countryInfo{146, "Djibouti", "Djibouti", "Africa"},
	...
	countryInfo{153, "Eswatini", "Mbabane", "Africa"},
	...
	countryInfo{159, "The Gambia", "Banjul", "Africa"},
	...
	countryInfo{165, "Cape Verde", "Praia", "Africa"},
	countryInfo{166, "Samoa", "Apia", ""},
	countryInfo{167, "Luxembourg", "Luxembourg City", ""},
	countryInfo{168, "Mauritius", "Port Louis", "Africa"},
	countryInfo{169, "Comoros", "Moroni", "Africa"},
	countryInfo{170, "Sao Tome and Principe", "Sao Tome", "Africa"},
	...
	countryInfo{180, "Seychelles", "Victoria", "Africa"},
