...
var countries = []countryInfo{
	...
	{21, "Niger", "Niamey", []string{africa}, "franc", "NE", "RN", true, ""},
	{22, "Angola", "Luanda", []string{africa}, "kwanza", "AO", "ANG", true, ""},
	{23, "Mali", "Bamako", []string{africa}, "franc", "ML", "RMM", false, ""},
	{24, "South Africa", "Pretoria", []string{africa}, "rand", "ZA", "ZA", false, ""},
	{25, "Colombia", "Bogota", []string{south_america}, "peso", "CO", "CO", false, ""},
	{26, "Ethiopia", "Addis Ababa", []string{africa, middle_east}, "birr", "ET", "ETH", true, ""},
	{27, "Bolivia", "Sucre", []string{south_america}, "boliviano", "BO", "BOL", true, ""},
	{28, "Mauritania", "Nouakchott", []string{africa}, "ouguiya", "MR", "RIM", false, ""},
	{29, "Egypt", "Cairo", []string{africa}, "pound", "EG", "ET", false, ""},
	{30, "Tanzania", "Dodoma", []string{africa}, "shilling", "TZ", "EAT", false, ""},
	{31, "Nigeria", "Abuja", []string{africa}, "naira", "NG", "WAN", false, ""},
	{32, "Venezuela", "Caracas", []string{south_america}, "bolivar", "VE", "YV", false, ""},
	{33, "Pakistan", "Islamabad", []string{asia, south_asia}, "rupee", "PK", "PK", false, ""},
	{34, "Namibia", "Windhoek", []string{africa}, "dollar", "NA", "NAM", false, ""},
	{35, "Mozambique", "Maputo", []string{africa}, "metical", "MZ", "MOC", false, ""},
	{36, "Turkey", "Ankara", []string{asia, europe, middle_east}, "lyra", "TR", "TR", false, ""},
	{37, "Chile", "Santiago", []string{south_america}, "peso", "CL", "RCH", false, ""},
	{38, "Zambia", "Lusaka", []string{africa}, "kwacha", "ZM", "Z", true, ""},
	{39, "Myanmar", "Naypyidaw", []string{southeast_asia}, "kyat", "MM", "BUR", false, ""},
	{40, "Afghanistan", "Kabul", []string{south_asia}, "afghani", "AF", "AFG", true, ""},
	{41, "South Sudan", "Juba", []string{africa}, "pound", "SS", "", true, ""},
	{42, "France", "Paris", []string{europe}, "euro", "FR", "F", false, ""},
	{43, "Somalia", "Mogadishu", []string{africa}, "shilling", "SO", "SO", false, ""},
	{44, "Central African Republic", "Bangui", []string{africa}, "franc", "CF", "RCA", true, ""},
	{45, "Ukraine", "Kyiv", []string{europe}, "hryvnia", "UA", "UA", false, ""},
	{46, "Madagascar", "Antananarivo", []string{africa}, "ariary", "MG", "RM", false, ""},
	{47, "Botswana", "Gaborone", []string{africa}, "pula", "BW", "BW", true, ""},
	{48, "Kenya", "Nairobi", []string{africa}, "shilling", "KE", "EAK", false, ""},
	{49, "Yemen", "Sana'a", []string{middle_east}, "rial", "YE", "YAR", false, ""},
	{50, "Thailand", "Bangkok", []string{southeast_asia}, "baht", "TH", "T", false, ""},
	{51, "Spain", "Madrid", []string{europe}, "euro", "ES", "E", false, ""},
	{52, "Turkmenistan", "Ashgabat", []string{asia}, "manat", "TM", "TM", true, ""},
	{53, "Cameroon", "Yaounde", []string{africa}, "franc", "CM", "CAM", false, ""},
	{54, "Papua New Guinea", "Port Moresby", []string{oceania}, "kina", "PG", "PNG", false, ""},
	{55, "Sweden", "Stockholm", []string{europe}, "krona", "SE", "S", false, ""},
	{56, "Uzbekistan", "Tashkent", []string{asia}, "som", "UZ", "UZ", true, ""},
	{57, "Morocco", "Rabat", []string{africa}, "dirham", "MA", "MA", false, ""},
	{58, "Iraq", "Baghdad", []string{middle_east}, "dinar", "IQ", "IRQ", false, ""},
	{59, "Paraguay", "Asuncion", []string{south_america}, "guarani", "PY", "PY", true, ""},
	{60, "Zimbabwe", "Harare", []string{africa}, "US dollar", "ZW", "ZW", true, ""},
	{61, "Norway", "Oslo", []string{europe}, "krone", "NO", "N", false, ""},
	{62, "Japan", "Tokyo", []string{asia}, "yen", "JP", "J", false, ""},
	{63, "Germany", "Berlin", []string{europe}, "euro", "DE", "D", false, ""},
	{64, "Republic of the Congo", "Brazzaville", []string{africa}, "franc", "CG", "RCB", false, ""},
	{65, "Finland", "Helsinki", []string{europe}, "euro", "FI", "FIN", false, ""},
	{66, "Viet Nam", "Hanoi", []string{southeast_asia}, "dong", "VN", "VN", false, ""},
	{67, "Malaysia", "Kuala Lumpur", []string{southeast_asia}, "ringgit", "MY", "MAL", false, ""},
	{68, "Ivory Coast", "Yamoussoukro", []string{africa}, "franc", "CI", "CN", false, ""},
	{69, "Poland", "Warsaw", []string{europe}, "zloty", "PL", "PL", false, ""},
	{70, "Oman", "Muscat", []string{middle_east}, "rial", "OM", "OM", false, ""},
	{71, "Italy", "Rome", []string{europe}, "euro", "IT", "I", false, ""},
	{72, "Phillipines", "Manila", []string{southeast_asia}, "peso", "PH", "RP", false, ""},
	{73, "Ecuador", "Quito", []string{south_america}, "US dollar", "EC", "EC", false, ""},
	{74, "Burkina Faso", "Ouagadougou", []string{africa}, "franc", "BF", "BF", true, ""},
	{75, "New Zealand", "Wellington", []string{oceania}, "dollar", "NZ", "NZ", false, ""},
	{76, "Gabon", "Libreville", []string{africa}, "franc", "GA", "G", false, ""},
	{77, "Guinea", "Conakry", []string{africa}, "franc", "GN", "RG", false, ""},
	{78, "United Kingdom", "London", []string{europe}, "pound", "GB", "UK", false, ""},
	{79, "Uganda", "Kampala", []string{africa}, "shilling", "UG", "EAU", true, ""},
	{80, "Ghana", "Accra", []string{africa}, "cedi", "GH", "GH", false, ""},
