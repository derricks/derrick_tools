...
var countries = []countryInfo{
	countryInfo{1, "Russia", "Moscow", []string{asia, europe}, "ruble", "RU", "RUS", false, "kopeck"},
	countryInfo{2, "Canada", "Ottawa", []string{north_america}, "dollar", "CA", "CDN", false, "cent"},
	countryInfo{3, "United States", "Washington, D.C.", []string{north_america}, "US dollar", "US", "USA", false, "cent"},
	countryInfo{4, "China", "Beijing", []string{asia}, "renminbi", "CN", "RC", false, "jiao"},
	countryInfo{5, "Brazil", "Brasilia", []string{south_america}, "real", "BR", "BR", false, "centavo"},
	countryInfo{6, "Australia", "Canberra", []string{oceania}, "Australian dollar", "AU", "AUS", false, ""},
	countryInfo{7, "India", "New Delhi", []string{south_asia}, "rupee", "IN", "IND", false, "paisa"},
	countryInfo{8, "Argentina", "Buenos Aires", []string{south_america}, "peso", "AR", "RA", false, "centavo"},
	countryInfo{9, "Kazakhstan", "Nur-Sultan", []string{asia, europe}, "tenge", "KZ", "KZ", true, "tiyin"},
	countryInfo{10, "Algeria", "Algiers", []string{africa}, "dinar", "DZ", "DZ", false, "centime"},
	countryInfo{11, "Democratic Republic of Congo", "Kinshasa", []string{africa}, "franc", "CD", "CGO", false, "centime"},
	countryInfo{12, "Saudi Arabia", "Riyadh", []string{middle_east}, "riyal", "SA", "KSA", false, "halala"},
	countryInfo{13, "Mexico", "Mexico City", []string{central_america, north_america}, "peso", "MX", "MEX", false, "centavo"},
	countryInfo{14, "Indonesia", "Jakarta", []string{southeast_asia}, "rupiah", "ID", "RI", false, "sen"},
	countryInfo{15, "Sudan", "Khartoum", []string{africa}, "pound", "SD", "SUD", false, "piastre"},
	countryInfo{16, "Libya", "Tripoli", []string{africa}, "dinar", "LY", "LAR", false, "dirham"},
	countryInfo{17, "Iran", "Tehran", []string{middle_east}, "rial", "IR", "IR", false, "rial"},
	countryInfo{18, "Mongolia", "Ulaanbataar", []string{asia}, "tugrik", "MN", "MGL", true, "mongo"},
	countryInfo{19, "Peru", "Lima", []string{south_america}, "sol", "PE", "PE", false, "centimo"},
	countryInfo{20, "Chad", "N'Djamena", []string{africa}, "franc", "TD", "TCH", false, "centime"},
